...
public class OutGroupEvaluateActivity extends TitleActivity implements OnClickListener{
	/* (non-Javadoc)
	 * @see android.app.Activity#onCreate(android.os.Bundle)
	 */
	private ListView listView;
	private String outgroupUrl = "stuListOutGroupEvaluation.do";
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_evaluate_outgroup);
		...
		listView.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1,
				...
				int grNumber = (Integer)map.get("grNumber");
				Intent intent = new Intent();
				intent.setClass(OutGroupEvaluateActivity.this, OutGroupEvaluateDetailActivity.class);
				Bundle bundle = new Bundle();
				bundle.putInt("grNumber",grNumber);
		...
		//通过访问服务器，获取数据
		GetData(baseInfo.getUrl()+outgroupUrl, params);
	...
	private void GetData(String URL, RequestParams params){
		http.send(HttpRequest.HttpMethod.GET,
			...
			public void onSuccess(ResponseInfo<String> responseInfo) {
				...
				List<Map<String, Object>> groups = getMaps("groupnumsVo", responseInfo.result);

				SimpleAdapter adapter = new SimpleAdapter(OutGroupEvaluateActivity.this,groups,R.layout.activity_evaluate_outgroup_items,
						new String[]{"grNumber"},
						new int[]{R.id.grNumber});

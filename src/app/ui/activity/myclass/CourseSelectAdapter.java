...
public class CourseSelectAdapter extends BaseAdapter{
    ...
    public CourseSelectAdapter(Context context, List<String> userList)  
    {  
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {  
        ViewHolder holder;  
        if (convertView == null) {  
            convertView = LayoutInflater.from(context).inflate(R.layout.activity_course_select_items, null);  
            holder = new ViewHolder();  
            holder.background = (LinearLayout) convertView.findViewById(R.id.course_select_list_item);  
            holder.userName = (TextView) convertView.findViewById(R.id.seName);  
